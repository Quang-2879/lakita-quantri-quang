    ...
    <div class="page-content">
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <h3 class="page-title">
                    Bài kiểm tra <small>Danh sách</small>
                </h3>
            ...
            <div class="col-md-12">
                ...
                <div class="portlet box light-grey">
                    <div class="portlet-title">
                        <div class="caption">
                            <i class="fa fa-file-text"></i> Danh sách bài kiểm tra (<?php echo number_format($total); ?> bản ghi)
                        </div>
                    </div>
                    <div class="portlet-body">
                        <div class="table-toolbar">
                            <div class="btn-group">
                                <a class="btn green" href="<?php echo base_url(); ?>examination/update"><i class="fa fa-plus"></i> Thêm mới</a>
                            ...
                            <div class="btn-group pull-right">
                                <form action="<?php echo base_url(); ?>examination/search" method="post">
                                    ...
                                    <?php if (isset($is_search)) { ?>
                                        ...
                                        <button type="submit" onclick="window.location = window.location.protocol + '//' + window.location.host + '/' + 'examination/index'; return false;" class="btn red">Hủy</button>
...
<?php } ?>
                        ...
                        <table class="table table-striped table-bordered table-hover" id="sample_1">
                            ...
                            <form class="form-horizontal" role="form" action="<?php echo base_url(); ?>examination/delete" method="POST" id="form-del">
...
<?php foreach ($rows as $key => $value) { ?>
    ...
    <?php echo $value['id']; ?>
                                        ...
                                        <td>
                                            ...
                                            <a href="<?php echo base_url() . 'examination/update/' . $value['id']; ?>">
    ...
    <?php if ($value['status']) { ?>
                                                ...
                                                <a href="<?php echo base_url() . 'examination/status/' . $value['id'] . '/' . $value['status']; ?>" class="txt-center btn btn-sm green filter-cancel curr_segment"><i class="fa fa-check"></i></a>												

    <?php } else { ?>

                                                <a href="<?php echo base_url() . 'examination/status/' . $value['id'] . '/' . $value['status']; ?>" class="txt-center btn btn-sm yellow filter-cancel curr_segment"><i class="fa fa-times"></i></a>												
    ...
    <?php } ?>
                                        ...
                                        <td class="center">
                                            ...
                                            <a href="<?php echo base_url() . 'examination/update/' . $value['id']; ?>" class="btn default btn-xs purple curr_segment">
                                            ...
                                            <a href="<?php echo base_url() . 'examination/delete/' . $value['id']; ?>" onclick="return confirm('Bạn chắc chắn muốn xoá bản ghi này?');" class="btn default btn-xs red curr_segment">
...
<input type="hidden" id="page" value="examination">
<!-- END CONTENT -->
